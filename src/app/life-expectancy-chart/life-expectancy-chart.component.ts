...
export class LifeExpectancyChartComponent implements OnChanges, AfterViewInit {
  ...
  /** The grid fills 80% of the viewport height, per the brief. */
  private static readonly HEIGHT_FRACTION = 0.8;
   ...
   * largest radius that fits both the container's width and 80% of the viewport height.
   */
  private createChart(): void {
    ...
    const availableHeight = window.innerHeight * LifeExpectancyChartComponent.HEIGHT_FRACTION;
